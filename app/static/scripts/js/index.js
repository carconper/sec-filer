...
ReactDOM.render(
    React.createElement(MainContainer, {title: "SEC Filinger"}),
    document.getElementById('mount-point')
);

},{"./components/MainContainer":3}],3:[function(require,module,exports){
	...
	render: function() {
		return (
			React.createElement("div", {className: "container"}, 
				React.createElement("h1", null, " MainContainer Component "), 
...
},{"./ResultsComponent":4,"./SearchComponent":5}],4:[function(require,module,exports){
var ResultsComponent = React.createClass({displayName: "ResultsComponent",

  render: function () {
    return (
      React.createElement("div", {class: "result"}, 
        React.createElement("p", null, " Here the results ")
      )
    )
  }
...
var SearchComponent = React.createClass({displayName: "SearchComponent",
  ...
  _renderButton: function() {
    ...
    return (
			React.createElement("button", {className: "btn-search", type: "button"}, "Show Filings")
    )
  },
	...
	render: function() {
		return (
			React.createElement("div", {class: "search"}, 
				...
				React.createElement("button", {className: "btn-search", type: "button", onClick:  this.companySearch}, "Search"), 
        this._renderButton()
			)
		)
	}
...
},{"../Constants":1,"axios":6}],6:[function(require,module,exports){
